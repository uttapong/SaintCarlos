...
<section id="content">
  ...
  <div class="main-block">
	...
	<h3>Колоноскопия</h3>
	 <h4>Эта процедура по обследованию толстого кишечника и она аналогична гастроскопии, но световод (толщина вводимой трубки меньше толщины пальца) вводится через прямую кишку и медленно продвигается под контролем зрения в толстую кишку. Врач видит картинку, получаемую при обследовании, либо на экране, либо наблюдает непосредственно в окуляр световода. Этот метод под наблюдением глаза более точный, чем контрастная рентгеноскопия с барием.</h4><br>
